...
\draw[fill=black!50, draw=none] (-1.5, -3) rectangle (7.5, 3);
\node (obs) at (0, 0) {\includegraphics[width=2cm]{jwst_spacecraft}};
...
\begin{scope}[canvas is zy plane at x=3, transform shape]
        \node (source) at (0, 0.5) {\includegraphics[height=3cm]{obs_horseshoe}};
...
\begin{scope}[canvas is zy plane at x=6, transform shape]
        \node (source) at (0, 0.5) {\includegraphics[height=3cm]{source_pred_horseshoe2}};
