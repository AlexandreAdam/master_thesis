...
%input
  ...
  \begin{scope}[canvas is yz plane at x=0,transform shape]
    \node{\includegraphics[width=2cm,height=2cm]{kappa_grad0}};
  ...
  \begin{scope}[canvas is zy plane at x=0.6,transform shape]
	\node{\includegraphics[width=2cm,height=2cm]{lens}};
  \end{scope}
...
\node[rectangle, rounded corners, draw=black, fill=black!20, scale=0.6] (plus) at (10, 0) {Add};
\draw[-latex, color=darkgray] (9.05, 0) -- (9.7, 0);
\draw[-latex, color=darkgray] (10.3, 0) -- (10.6, 0);
  ...
  \begin{scope}[canvas is yz plane at x=12.2,transform shape]
    \node{\includegraphics[width=2cm,height=2cm]{source_grad1}};
  ...
  \begin{scope}[canvas is yz plane at x=12.8,transform shape]
    \node{\includegraphics[width=2cm,height=2cm]{kappa_grad1}};
...
\node[rectangle, rounded corners, draw=black, fill=black!20, scale=0.6, 
...
\draw[-latex, color=darkgray] (11.15, -1.47) -- (11, -1.9);

\begin{scope}[canvas is zy plane at x=11,transform shape]
  \node (source) at (0, -4) {\includegraphics[width=1.5cm,height=1.5cm]{lens_t2}};
\end{scope}
\draw[-latex, color=darkgray] (11, -2.5) -- (11, -2.8);
...
\draw[-latex, color=darkgray] (11., -4) -- (12.1, -4);
