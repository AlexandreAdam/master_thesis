...
\citet{Zwicky1937b} propose d'ailleurs un estimé de la masse de l'amas de Coma à 
$\gtrsim 4.5\times  10^{13}M_\odot$ avec le théorème du viriel. 
...
\citet{Einstein1936} considérait l'éventualité d'observer des lentilles gravitationnelles comme étant extrêmement 
...
suivant l'identification de deux spectres radios de quasars identiques, QSO 0957+561 A et B (voir Figure \ref{fig:double quasar}), séparés par $5.7$ secondes d'arcs
...
À la suite de cette découverte fortuite et la découverte subséquente des arcs lumineux (par exemple, voir la Figure \ref{fig:sdssj1148}) 
dans les amas de galaxies \citep{Lynds1989}, l'étude des lentilles gravitationnelles est devenue un sujet d'étude 
particulièrement riche et prometteur en cosmologie \citep{Blandford1992,Bartelmann2010,Treu2010}. 
Par exemple, les quasars lentillés comme RXJ1131-1231 (voir la Figure \ref{fig:rxj1131}) 
permettent de mesurer la constante de \citet{Hubble1929}, $H_0$, un paramètre qui quantifie le taux de l'expansion de l'Univers au temps présent. 
L'idée principale derrière cette méthode est l'estimation du délai temporel entre chaque images du quasar par une surveillance décennale de la lentille 
gravitationnelle \citep[e.g.][]{Vanderriest1989,Wong2020}. 
De façon alternative, la constante de Hubble peut être estimé par la caractérisation de la courbe de lumière des supernovas lentillées 
