...
On assume d'abord la chaîne de Markoz $Y \rightarrow X \rightarrow Z$ pour les variables 
...
Le travail de \citet{Younger2001} est la première apparition concrète d'une approche basée seulement sur la rétropropagation de gradients 
...
connecté par la fonction qu'on essai d'approximer. Pour le méta-apprentissage, l'ensemble d'entraînement est constitué de tâches à performer. Dans 
