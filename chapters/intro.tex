...
est un objet particulièrement riche en information\footnote{On note aussi les contributions de Chwoelsky 1924, et d'autres travaux spéculatifs d'avant}. 
...
\begin{enumerate}
        ...
        \item de mesurer directement la masse gravitationnelle de galaxies (appellées nébuleuse extra-galactique à l'époque) agissant 
                comme lentilles.
\end{enumerate}
À l'époque, \citet{Einstein1936} considérait l'éventualité d'observer ces systèmes extrêmement 
improbable en raison de la miniscule distance angulaire caractéristique $\theta_E$ entre deux images de la source
...
\end{equation}
%Bien sûr à cette époque, la masses des galaxies (voir Zwicky 1937-- october article) n'était bien caractériser (sans parler de D), 
% Alors il était difficile d'imager la tailler de ces objets. Voir Link, maybe there is something there.
