...
d'un maximum qu'on nomme la capacité du système $C = \underset{X\sim P(X)}{\mathrm{max}} I(X;\,Z)$. 
...
on contraint la complexité de Kolmogorov du message, ç.-à-d. qu'on force le message à utiliser le moins de bit possible. C'est 
le principe de base de la théorie du taux de distortion \citep{Cover2006}.  
