...
Il s'avère que l'objectif de comprimer l'information est intimement lié à l'objectif de d'obtenir un sommaire informatif; ç.-à-d. qu'un 
code d'une complexité de Kolmogorov minimale décrit la source d'information de la manière la plus informative possible. Cette connexion 
remarquable, observée par \citet{kolmogorov1965,}, est une application concrète du principe du rasoir d'Occam: l'explication adéquate la plus simple est la meilleure.
