...
% Add items to glossary without displaying them
  ...
  \frontmatter
	...
	galaxy, is bent by the gravitational field of a foreground galaxy, producing double, quadruple or even 
	...
	But traditional methods to study these systems often require significant compute time (from hours to days), 
	and this is without taking into account the time spent by experts required 
	...
	we demonstrate using realistic of mass density profiles from the cosmological 
	hydrodynamic simulation IllustrisTNG.
	Our reconstructions are executed in a fraction of the time required by traditional methods, 
	at a resolution comparable to the Hubble Space Telescope (HST), which is a significant step 
